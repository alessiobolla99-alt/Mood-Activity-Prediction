...
from sklearn.model_selection import learning_curve, RandomizedSearchCV, TimeSeriesSplit
...
def temporal_train_test_split(df, test_size=0.2):
    ...
    if 'date_parsed' in df.columns:
        ...
        feature_cols = [col for col in df.columns if col not in ['target', 'date_parsed']]
